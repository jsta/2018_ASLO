...
\titlegraphic{\includegraphics[width=2cm,height=2cm]{../logos/cnh-lakes} %
\includegraphics[width=2cm,height=2cm]{../logos/logo_msu-fw} %
\includegraphics[width=2cm,height=2cm]{../logos/cont-limno}}
