...
## P retention models \cite{vollenweiderInputoutputModels1975}
...
\hfill\column{0.46\textwidth}

\vspace{1em}

\nocite{MilsteadEstimatingSummerNutrient2013}
```{r milstead, echo=FALSE, warning=FALSE, fig.width=2.8, fig.height=2.3, cache=TRUE}
library(ggplot2)
...
\includegraphics[width=0.75\textwidth]{figures/06_k-1.pdf}

## Connectivity metric importance

\vspace{-1em}

\small

|Metric                |Scale |Connectivity Type | Delta k |
|:---------------------|:-----|:-----------------|:-------:|
|`Average link length`   |`Network`   |`Longitudinal`   |  `0.23`   |
|`Closest lake distance` |`Network`   |`Longitudinal`|  `0.22`   |
|Stream density        |Network   |Lateral       |  0.20   |
|Lake connection       |Focal     |Longitudinal      |  0.17   |
|Upstream lake area    |Network   |Longitudinal  |  0.16   |
|Max depth             |Focal     |-                 |  0.15   |
|Average link length   |Lake      |Longitudinal     |  0.14   |
|Baseflow              |Lake      |Lateral          |  0.12   |
|Stream order ratio    |Lake      |Longitudinal     |  0.10   |
...
\includegraphics[width=\textwidth]{figures/conceptual_p-cycle_pt5.png}
...
Connectivity at the network scale is more important than connectivity at finer scales.
